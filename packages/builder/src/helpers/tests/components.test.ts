...
vi.mock("@/stores/builder", async () => {
  ...
  return {
    componentStore: writable({
      components: {
        "@supertoolmake/standard-components/button": {
          friendlyName: "Primary button",
          name: "Button",
        },
        "@supertoolmake/standard-components/container": {
          name: "Container",
        },
        "@supertoolmake/standard-components/textv2": {
          name: "Text",
        },
      },
    }),
...
describe("component tree search", () => {
  ...
  it("returns empty sets for an empty search", () => {
    const results = getComponentTreeSearchResults(
      [
        component({
          id: "button-1",
          type: "@supertoolmake/standard-components/button",
        }),
      ],
      ""
    )
  ...
  it("matches component labels shown in the tree", () => {
    ...
    const table = component({
      id: "table-1",
      type: "@supertoolmake/standard-components/table",
    })
  ...
  it("matches component type names but not hidden metadata", () => {
    ...
    const renamedContainer = component({
      id: "container-1",
      type: "@supertoolmake/standard-components/container",
      name: "Outer panel",
    })
    const renamedText = component({
      id: "text-1",
      type: "@supertoolmake/standard-components/textv2",
      name: "bruh",
    })
