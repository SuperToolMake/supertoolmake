var buffer = (() => {
  ...
  var k = (i, r) => () => (r || i((r = { exports: {} }).exports, r), r.exports),
    xr = (i, r) => {
      for (var t in r) M(i, t, { get: r[t], enumerable: !0 })
    },
    Br = (i, r, t, n) => {
      if ((r && typeof r == "object") || typeof r == "function")
        for (const e of yr(r))
          !wr.call(i, e) &&
            e !== t &&
            M(i, e, { get: () => r[e], enumerable: !(n = ar(r, e)) || n.enumerable })
      return i
    }
  var Er = (i) => Br(M({}, "__esModule", { value: !0 }), i)
  var X = k((S) => {
    S.byteLength = gr
    S.toByteArray = Ir
    S.fromByteArray = Ur
    var B = [],
      w = [],
      dr = typeof Uint8Array < "u" ? Uint8Array : Array,
      D = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
    for (m = 0, H = D.length; m < H; ++m) (B[m] = D[m]), (w[D.charCodeAt(m)] = m)
    var m, H
    w[45] = 62
    w[95] = 63
    function V(i) {
    ...
    function Ar(i, r, t) {
      for (var n, e = [], o = r; o < t; o += 3)
        (n = ((i[o] << 16) & 16711680) + ((i[o + 1] << 8) & 65280) + (i[o + 2] & 255)),
          e.push(Fr(n))
      return e.join("")
    }
    function Ur(i) {
      for (var r, t = i.length, n = t % 3, e = [], o = 16383, u = 0, f = t - n; u < f; u += o)
        e.push(Ar(i, u, u + o > f ? f : u + o))
      return (
        n === 1
            ...
            : ((u = Math.floor(Math.log(r) / Math.LN2)),
              ...
              u + p >= s
                ...
                : u + p >= 1
                  ...
                  : ((f = r * 2 ** (p - 1) * 2 ** e), (u = 0)));
        e >= 8;
        i[t + x] = f & 255, x += N, f /= 256, e -= 8
      );
      for (u = (u << e) | f, l += e; l > 0; i[t + x] = u & 255, x += N, u /= 256, l -= 8);
      i[t + x - N] |= lr * 128
    }
  })
  var sr = k((T) => {
    ...
    function d(i) {
      if (i > _) throw new RangeError('The value "' + i + '" is invalid for option "size"')
    ...
    h.poolSize = 8192
    function v(i, r, t) {
      if (typeof i == "string") return Cr(i, r)
      if (ArrayBuffer.isView(i)) return Sr(i)
      if (i == null)
        throw new TypeError(
    ...
    h.alloc = (i, r, t) => Tr(i, r, t)
    function q(i) {
      return rr(i), d(i < 0 ? 0 : Y(i) | 0)
    }
    h.allocUnsafe = (i) => q(i)
    h.allocUnsafeSlow = (i) => q(i)
    function Cr(i, r) {
    ...
    function P(i) {
      const r = i.length < 0 ? 0 : Y(i.length) | 0,
        t = d(r)
    ...
    function _r(i) {
      if (h.isBuffer(i)) {
        const r = Y(i.length) | 0,
          t = d(r)
        return t.length === 0 || i.copy(t, 0, 0, r), t
      }
      if (i.length !== void 0) return typeof i.length != "number" || j(i.length) ? d(0) : P(i)
      if (i.type === "Buffer" && Array.isArray(i.data)) return P(i.data)
    }
    function Y(i) {
      if (i >= _)
    ...
    h.isBuffer = (r) => r != null && r._isBuffer === !0 && r !== h.prototype
    h.compare = (r, t) => {
      if (
    ...
    h.prototype.toString = function () {
      const r = this.length
      return r === 0 ? "" : arguments.length === 0 ? nr(this, 0, r) : Nr.apply(this, arguments)
    }
    ...
    J && (h.prototype[J] = h.prototype.inspect)
    ...
    function Mr(i, r, t, n) {
      ...
      let u
      for (u = 0; u < n; ++u) {
        const f = parseInt(r.substr(u * 2, 2), 16)
        if (j(f)) return u
        i[t + u] = f
      }
      return u
    ...
    function br(i, r, t, n) {
      return L(zr(r, i.length - t), i, t, n)
    }
    h.prototype.write = function (r, t, n, e) {
      if (t === void 0) (e = "utf8"), (n = this.length), (t = 0)
        ...
        (t = t >>> 0),
          isFinite(n) ? ((n = n >>> 0), e === void 0 && (e = "utf8")) : ((e = n), (n = void 0))
      else
        throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported")
      const o = this.length - t
      if (
        ((n === void 0 || n > o) && (n = o), (r.length > 0 && (n < 0 || t < 0)) || t > this.length)
      )
    ...
    function Pr(i, r, t) {
      return r === 0 && t === i.length ? b.fromByteArray(i) : b.fromByteArray(i.slice(r, t))
    }
    function nr(i, r, t) {
    ...
    function Or(i) {
      ...
      let t = "",
        n = 0
      for (; n < r; ) t += String.fromCharCode.apply(String, i.slice(n, (n += Z)))
      return t
    }
    function Gr(i, r, t) {
      let n = ""
    ...
    h.prototype.readBigUInt64LE = g(function (r) {
      ...
      const e = t + this[++r] * 2 ** 8 + this[++r] * 2 ** 16 + this[++r] * 2 ** 24,
    ...
    h.prototype.readBigUInt64BE = g(function (r) {
      ...
      const t = this[r],
        n = this[r + 7]
      ;(t === void 0 || n === void 0) && C(r, this.length - 8)
      const e = t * 2 ** 24 + this[++r] * 2 ** 16 + this[++r] * 2 ** 8 + this[++r],
    ...
    h.prototype.readIntBE = function (r, t, n) {
      ...
      return (o *= 128), u >= o && (u -= 2 ** (8 * t)), u
    }
    h.prototype.readInt8 = function (r, t) {
      return (
        (r = r >>> 0), t || a(r, 1, this.length), this[r] & 128 ? (255 - this[r] + 1) * -1 : this[r]
      )
    }
    ...
    function hr(i, r, t, n, e) {
      return (
        (r = +r),
        (t = t >>> 0),
        e || ur(i, r, t, 4, 34028234663852886e22, -34028234663852886e22),
        U.write(i, r, t, n, 23, 4),
        t + 4
      )
    }
    h.prototype.writeFloatLE = function (r, t, n) {
      return hr(this, r, t, !0, n)
    }
    h.prototype.writeFloatBE = function (r, t, n) {
      return hr(this, r, t, !1, n)
    }
    function fr(i, r, t, n, e) {
      return (
        (r = +r),
        (t = t >>> 0),
        e || ur(i, r, t, 8, 17976931348623157e292, -17976931348623157e292),
        U.write(i, r, t, n, 52, 8),
        t + 8
      )
    }
    ...
    h.prototype.fill = function (r, t, n, e) {
      ...
      if (typeof r == "number") for (o = t; o < n; ++o) this[o] = r
        ...
        const u = h.isBuffer(r) ? r : h.from(r, e),
          f = u.length
    ...
    W(
      ...
      (i) =>
        i ? `${i} is outside of buffer bounds` : "Attempt to access memory outside buffer bounds",
      RangeError
    )
    W(
      "ERR_INVALID_ARG_TYPE",
      (i, r) => `The "${i}" argument must be of type number. Received type ${typeof r}`,
      TypeError
    )
    W(
      "ERR_OUT_OF_RANGE",
      (i, r, t) => {
        ...
        return (
          Number.isInteger(t) && Math.abs(t) > 2 ** 32
            ...
            : typeof t == "bigint" &&
              ((e = String(t)),
              (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (e = Q(e)),
              (e += "n")),
    ...
    function jr(i, r, t) {
      R(r, "offset"), (i[r] === void 0 || i[r + t] === void 0) && C(r, i.length - (t + 1))
    }
    function cr(i, r, t, n, e, o) {
      if (i > t || i < r) {
        ...
        throw (
          (o > 3
            ...
            : (f = `>= ${r}${u} and <= ${t}${u}`),
          new A.ERR_OUT_OF_RANGE("value", f, i))
        )
      }
      jr(n, e, o)
    }
    ...
    function C(i, r, t) {
      throw Math.floor(i) !== i
        ? (R(i, t), new A.ERR_OUT_OF_RANGE(t || "offset", "an integer", i))
        : r < 0
          ? new A.ERR_BUFFER_OUT_OF_BOUNDS()
          : new A.ERR_OUT_OF_RANGE(t || "offset", `>= ${t ? 1 : 0} and <= ${r}`, i)
    }
    var Hr = /[^+/0-9A-Za-z-_]/g
    function Vr(i) {
      if (((i = i.split("=")[0]), (i = i.trim().replace(Hr, "")), i.length < 2)) return ""
