...
if (descriptions.length) {
  describe.each(descriptions)("$dbName: CSV Export/Import Roundtrip", ({ config, dsProvider }) => {
    ...
    describe("Field Type Roundtrip Tests", () => {
      it("should handle string fields", async () => {
        ...
        const csvData = await config.api.row.exportRows(table._id!, {}, RowExportFormat.CSV)
