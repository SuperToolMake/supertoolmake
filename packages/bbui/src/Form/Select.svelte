...
export let getOptionSubtitle = (option: O, _index?: number) => (option as any)?.subtitle
export let showSelectedSubtitle = false
export let getOptionIcon = (option: O, _index?: number) => (option as any)?.icon
export let getOptionColour = (option: O, _index?: number) => (option as any)?.colour
export let useOptionIconImage = false
export let isOptionEnabled: ((_option: O, _index?: number) => boolean) | undefined = undefined
