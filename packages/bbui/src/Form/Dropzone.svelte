...
export let processFiles: ((_files: FileList) => Promise<Value[]>) | undefined = undefined
export let deleteAttachments: ((_keys: string[]) => Promise<void>) | undefined = undefined
export let handleFileTooLarge: ((_limit: number, _currentFiles: Value[]) => void) | undefined =
  undefined
export let handleTooManyFiles: ((_maximum: number) => void) | undefined = undefined
